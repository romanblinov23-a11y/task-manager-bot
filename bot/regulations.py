...
Я — Енисей, бот-менеджер задач. Слежу за договорённостями в рабочих чатах, личных сообщениях и протоколах встреч, фиксирую задачи по проектам и слежу за сроками.
